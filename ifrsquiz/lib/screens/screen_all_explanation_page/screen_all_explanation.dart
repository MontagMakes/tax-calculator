...
class ScreenAllExplanation extends StatefulWidget {
  const ScreenAllExplanation({super.key});

  @override
  State<ScreenAllExplanation> createState() => _ScreenAllExplanationState();
}

class _ScreenAllExplanationState extends State<ScreenAllExplanation> {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text("Explanation of all questions"),
        ),
