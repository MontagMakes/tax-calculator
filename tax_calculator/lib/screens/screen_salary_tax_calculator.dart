...
class SalaryTaxCalculatorScreen extends StatefulWidget {
  const SalaryTaxCalculatorScreen({super.key});

  @override
  State<SalaryTaxCalculatorScreen> createState() =>
      _SalaryTaxCalculatorScreenState();
}

class _SalaryTaxCalculatorScreenState extends State<SalaryTaxCalculatorScreen> {
  ...
  Map<String, double> resultForSalaried = {};
              ...
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(formatCurrency(resultForSalaried['monthlySalary'])),
                  ],
                ),
                const DottedLine(),
                const SizedBox(
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(formatCurrency(resultForSalaried['monthlyTax'])),
                  ],
                ),
                const DottedLine(),
                const SizedBox(
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(formatCurrency(
                        resultForSalaried['monthlySalaryAfterTax'])),
                  ],
                ),
                const DottedLine(),
                const SizedBox(
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(formatCurrency(resultForSalaried['yearlySalary'])),
                  ],
                ),
                const DottedLine(),
                const SizedBox(
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(formatCurrency(resultForSalaried['yearlyTax'])),
                  ],
                ),
                const DottedLine(),
                const SizedBox(
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(formatCurrency(
                        resultForSalaried['yearlySalaryAfterTax'])),
                  ],
                ),
                const DottedLine(),
                const SizedBox(
